...
def get_spitfire_template_class(prefer_c_extension=True):
  ...
  class _SpitfireTemplate(baseclass):
    ...
    #
    # when this is assigned to a template instance, accessing this name binds
    # the function to the current instance. using the name 'template_instance'
    # to indicate that these functions aren't really related to the template.
