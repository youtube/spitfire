...
o3_options.batch_buffer_writes = False
...
def add_common_options(op):
  ...
  op.add_option(
      '--fail-library-searchlist-access', action='store_true', default=False,
  ...
  op.add_option('--static-analysis', action='store_true',
                ...
                'of their scope.')
  op.add_option(
      '--default-to-strict-resolution', action='store_true', default=False,
  ...
  op.add_option(
      '--include-path', default='.', action='callback',
      callback=validate_path, type='str', nargs=1,
      help=
