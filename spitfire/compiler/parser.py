...
class _SpitfireParser(Parser):
    ...
    def statement(self):
        _token_ = self._peek("'implements'", "'allow_undeclared_globals'", "'loose_resolution'", "'extends'", "'absolute_extends'", "'from'", "'import'", "'slurp'", "'break'", "'continue'", "'global'", "'attr'", "'filter'", "'set'", "'echo'")
        if _token_ == "'implements'":
            ...
            CLOSE_DIRECTIVE = self.CLOSE_DIRECTIVE()
            return AllowUndeclaredGlobalsNode()
